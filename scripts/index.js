...
const bigImage = new PopupWithImage(popupAddCard, '.popup_big-image')

const formPopup = new PopupWithForm('.new-popup', {
  handleFormSubmit: () => {
    cardSection.addItem(createCard('.new-popup__action'));
  }
})
